...
VWriter::VWriter(const std::string & fileName, int width, int height) :
    width(width),
    height(height)
{
...
//=================================================
void VWriter::writeYUV(const uint8_t* data)
{
    fflush(stdout);
...
//=================================================
void VWriter::encode(AVFrame* pF)
{
